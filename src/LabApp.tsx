...
<div className="text-sm tracking-widest uppercase" style={{ color: '#0891b2' }}>Loading Halo</div>
</div>
</div>
);
}
...
<div class="sub">Halo Dental Lab · ${new Date().toLocaleDateString()}</div>
</div>
...
<div class="footer-mini">${lang === 'ar' ? 'امسح للتتبع' : 'Scan for tracking'} · Halo Dental Lab</div>
</div>
</div>
<script>setTimeout(() => window.print(), 500);</script>
</body>
...
<div class="report">
  <div class="header">
    ...
    <div class="meta">
      <div><strong>Halo Dental Lab</strong></div>
  ...
  <div class="footer">${lang === 'ar' ? 'تم الإنشاء بواسطة' : 'Generated by'} Halo Dental Lab Accounting System</div>
</div>
<script>setTimeout(() => window.print(), 500);</script>
</body>
</html>`);
...
${inv.notes ? `<div class="notes"><strong>${lang === 'ar' ? 'ملاحظات' : 'Notes'}:</strong> ${inv.notes}</div>` : ''}
  ...
  <div class="footer">${lang === 'ar' ? 'شكراً لتعاملكم معنا' : 'Thank you for your business'} · Halo Dental Lab${state.vatNumber ? ` · ${lang === 'ar' ? 'رقم ضريبي' : 'VAT'}: ${state.vatNumber}` : ''} · ${new Date().toLocaleDateString()}</div>
</div>
<script>setTimeout(() => window.print(), 500);</script>
</body>
</html>`);
...
a.href = url;
a.download = `halo-dental-export-${new Date().toISOString().split('T')[0]}.json`;
a.click();
...
const a = document.createElement('a');
a.href = url;
a.download = `halo-cases-${new Date().toISOString().split('T')[0]}.csv`;
a.click();
URL.revokeObjectURL(url);
};
  ...
  <div className="glass rounded-2xl p-6">
    ...
    <div className="grid sm:grid-cols-2 gap-3 mb-3">
      <div>
        ...
        <input className="themed mono" placeholder="halo-lab-01" value={cloudForm.labId} onChange={e => setCloudForm(f => ({ ...f, labId: e.target.value }))} disabled={state.cloud?.enabled} />
      </div>
      <div>
  ...
  <div className="glass rounded-2xl p-6">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-[12px]">
      <div className="p-3 rounded-lg" style={{ background: 'rgba(120, 180, 255, 0.04)' }}>
        ...
        <div className="font-bold" style={{ color: 'var(--text)' }}>Halo v6.0</div>
      </div>
      <div className="p-3 rounded-lg" style={{ background: 'rgba(120, 180, 255, 0.04)' }}>
