...
// accept formats like "lumen://case/C-2606-001"
...
<div className="text-cyan-100/60 text-sm tracking-widest uppercase">Loading Lumen</div>
</div>
</div>
);
}
...
<div class="sub">Lumen Dental Lab · ${new Date().toLocaleDateString()}</div>
</div>
...
<div class="footer-mini">${lang === 'ar' ? 'امسح للتتبع' : 'Scan for tracking'} · Lumen Dental Lab</div>
</div>
</div>
...
<div class="report">
  <div class="header">
    ...
    <div class="meta">
      <div><strong>Lumen Dental Lab</strong></div>
  ...
  <div class="footer">${lang === 'ar' ? 'تم الإنشاء بواسطة' : 'Generated by'} Lumen Dental Lab Accounting System</div>
</div>
<script>setTimeout(() => window.print(), 500);</script>
</body>
</html>`);
...
a.href = url;
a.download = `lumen-dental-export-${new Date().toISOString().split('T')[0]}.json`;
a.click();
...
const a = document.createElement('a');
a.href = url;
a.download = `lumen-cases-${new Date().toISOString().split('T')[0]}.csv`;
a.click();
URL.revokeObjectURL(url);
};
  ...
  <div className="glass rounded-2xl p-6">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-[12px]">
      <div className="p-3 rounded-lg" style={{ background: 'rgba(120, 180, 255, 0.04)' }}>
        ...
        <div className="font-bold" style={{ color: 'var(--text)' }}>Lumen v6.0</div>
      </div>
      <div className="p-3 rounded-lg" style={{ background: 'rgba(120, 180, 255, 0.04)' }}>
